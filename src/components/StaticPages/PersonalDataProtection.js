...
function PersonalDataProtection (){
           return(
            ...
            <div className="tab-content tab_in_cms_reset" id="nav-tabContent">
                <div className="tab-pane fade show active" id="eng_lang" role="tabpanel" aria-labelledby="lang_eng_tab">
                    ...
                    <div className="info_text_con">
                        <ol>
                            ...
                            <li>Your personal data may be disclosed to parties such as but not limited to banks, auditors, governmental departments and / or agencies, regulatory and / or statutory bodies, credit check companies, our related corporations and / or members of Tan Chong Motor Holdings Berhad, Warisan TC Holdings Berhad, APM Automotive Holdings Berhad and their respective subsidiaries, business partners, service providers and third party any such requested or authorized by you for any of the above. Purposes or any other purpose for which your personal data was to be disclosed at the time of its collection or any other purpose directly related to any of the above purposes.</li>
                ...
                <div className="tab-pane fade" id="malay_lang" role="tabpanel" aria-labelledby="lang_malay_tab">
                    <div className="info_text_con">
                        <h5 className="">
                            <b>
